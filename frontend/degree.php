...
<body>
	<div class="container">
		...
		<form id="degreeForm" action="../backend/process_application.php" method="post">
			...
			<div class="form-group">
				<label for="tbjee_roll_no">TBJEE Roll No.</label>
				<input type="text" id="tbjee_roll_no" name="tbjee_roll_no">
			</div>
			...
			<div class="form-group">
				<label for="board_madhyamik">Board (Madhyamik)</label>
				<input type="text" id="board_madhyamik" name="board_madhyamik">
			</div>
			...
			<div class="form-group">
				<label for="exam_passed_hs">H.S. (+2 Stage) or Equivalent Exam Passed</label>
				<input type="text" id="exam_passed_hs" name="exam_passed_hs"
					value="H.S. (+2 Stage) or Equivalent" readonly>
			</div>


			<div class="form-group">
				<label for="board_hs">Board/Council (H.S.)</label>
				<input type="text" id="board_hs" name="board_hs">
			</div>


			<div class="form-group">
				<label for="year_of_passing_hs">Year of Passing (H.S.)</label>
				<input type="number" id="year_of_passing_hs" name="year_of_passing_hs">
			</div>


			<div class="form-group">
				<label for="main_subjects_physics">Main Subjects (Physics)</label>
				<input type="text" id="main_subjects_physics" name="main_subjects_physics" value="Physics"
					readonly>
			</div>


			<div class="form-group">
				<label for="full_marks_physics">Full Marks (Physics)</label>
				<input type="number" id="full_marks_physics" name="full_marks_physics">
			</div>


			<div class="form-group">
				<label for="marks_obtained_physics">Marks Obtained (Physics)</label>
				<input type="number" id="marks_obtained_physics" name="marks_obtained_physics">
			</div>


			<div class="form-group">
				<label for="main_subjects_chemistry">Main Subjects (Chemistry)</label>
				<input type="text" id="main_subjects_chemistry" name="main_subjects_chemistry" value="Chemistry"
					readonly>
			</div>


			<div class="form-group">
				<label for="full_marks_chemistry">Full Marks (Chemistry)</label>
				<input type="number" id="full_marks_chemistry" name="full_marks_chemistry">
			</div>


			<div class="form-group">
				<label for="marks_obtained_chemistry">Marks Obtained (Chemistry)</label>
				<input type="number" id="marks_obtained_chemistry" name="marks_obtained_chemistry">
			</div>


			<div class="form-group">
				<label for="main_subjects_math">Main Subjects (Mathematics)</label>
				<input type="text" id="main_subjects_math" name="main_subjects_math" value="Mathematics"
					readonly>
			</div>
