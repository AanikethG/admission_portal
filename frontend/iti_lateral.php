...
<head>
	...
	<title>ITI Lateral Entry Admission Form</title>
...
<body>
	<div class="container">
		<h2>ITI Lateral Entry Admission Form</h2>
		<form id="itiLateralForm" action="../backend/process_application.php" method="post">
			<input type="hidden" name="program_type" value="ITILateral">
			...
			<div class="form-group">
				<label for="itilee_roll_no">ITILEE Roll No</label>
				<input type="text" id="itilee_roll_no" name="itilee_roll_no">
			</div>
			...
			<div class="form-group">
				<label for="exam_passed_iti">ITI Exam Passed</label>
				<input type="text" id="exam_passed_iti" name="exam_passed_iti" value="ITI" readonly>
			</div>


			<div class="form-group">
				<label for="board_university_iti">Board/University (ITI)</label>
				<input type="text" id="board_university_iti" name="board_university_iti">
			</div>


			<div class="form-group">
				<label for="year_of_passing_iti">Year of Passing (ITI)</label>
				<input type="number" id="year_of_passing_iti" name="year_of_passing_iti">
			</div>


			<div class="form-group">
				<label for="full_marks_iti">Full Marks (ITI)</label>
				<input type="number" id="full_marks_iti" name="full_marks_iti">
			</div>


			<div class="form-group">
				<label for="marks_obtained_iti">Marks Obtained (ITI)</label>
				<input type="number" id="marks_obtained_iti" name="marks_obtained_iti">
			</div>


			<div class="form-group">
				<label for="overall_percentage_iti">Overall Percentage (ITI)</label>
				<input type="number" id="overall_percentage_iti" name="overall_percentage_iti">
			</div>
	...
	<script>
		...
		document.getElementById('itiLateralForm').addEventListener('submit', function(event) {
			let isValid = true;
